...
let productArr: FilterProduct = loadList('ACCESS');
    ...
    <>
      <section className="itemlist">
        ...
        <ul className="btn_wrap">
          ...
          >
            <Link to="/access" state={{ kindnumber: 2 }}>
          ...
          >
            <Link to="/access" state={{ kindnumber: 3 }}>
          ...
          >
            <Link to="/access" state={{ kindnumber: 4 }}>
          ...
          >
            <Link to="/access" state={{ kindnumber: 5 }}>
